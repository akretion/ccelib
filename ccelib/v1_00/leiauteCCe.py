...
#
# Generated Thu Apr 25 20:24:05 2019 by generateDS.py version 2.30.24.
...
#   ('-f', '')
#   ('-o', '/tmp/edocs/ccelib/v1_00/leiauteCCe.py')
#
# Command line arguments:
#   -
#
# Command line:
#   /home/rvalyi/DEV/generateds/generateDS.py --no-namespace-defs --use-getter-setter="none" -f -o "/tmp/edocs/ccelib/v1_00/leiauteCCe.py" -
#
...
class tpEventoType(Enum):
    """Tipo do Evento"""
    _1_10110='110110'


class verEventoType(Enum):
...
class detEventoType(GeneratedsSuper):
    ...
    subclass = None
    superclass = None
    def __init__(self, versao=None, descEvento=None, xCorrecao=None, xCondUso=None, **kwargs_):
        self.original_tagname_ = None
        self.parent_object_ = kwargs_.get('parent_object_')
        self.versao = _cast(None, versao)
